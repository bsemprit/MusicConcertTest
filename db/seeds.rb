...
dog_days_tour = Concert.create(artist: "Florence and the Machine", venue: "American Airlines Arena", city: "Miami", date: DateTime.new(2016, 2, 25), price: 100.00, description: "Computational processes are abstract beings that inhabit computers. As they evolve, processes manipulate other abstract things called data. The evolution of a process is directed by a pattern of rules called a program. People create programs to direct processes. In effect, we conjure the spirits of the computer with our spells.")
...
swedish_tour = Concert.create(artist: "Joris Voorn", venue: "Electric Pickle", city: "Miami", date: DateTime.new(2016, 2, 22), price: 20.00, description: "Computational processes are abstract beings that inhabit computers. As they evolve, processes manipulate other abstract things called data. The evolution of a process is directed by a pattern of rules called a program. People create programs to direct processes. In effect, we conjure the spirits of the computer with our spells.")

puts "yo"
puts goddess_tour.errors.full_messages
puts dog_days_tour.errors.full_messages
puts tropical_tour.errors.full_messages
puts swedish_tour.errors.full_messages
